...
import { Crown, LogIn, Mail, Lock, AlertCircle, Eye, EyeOff } from "lucide-react";
          ...
          >
            ...
            <div className="space-y-5">
              ...
              <p className="text-gray-400 text-xl leading-relaxed max-w-md">
                Join thousands of players worldwide. Challenge opponents, solve
                puzzles, and elevate your chess skills.
              </p>
            </div>
            ...
            <div className="space-y-5">
              {[
                ...
                "Improve with daily puzzles and lessons",
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <motion.button
                ...
                type="submit"
                disabled={loading}
                className="w-full h-12 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-5 shadow-lg shadow-blue-600/20"
              >
                {loading ? (
